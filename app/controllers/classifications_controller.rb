class ClassificationsController < ApplicationController
  ...
  def create
    ...
    @classification = Classification.new(name: @new_classification[:name], icon: @new_classification[:icon],
                                         author: current_user)
  ...
  def update
    respond_to do |format|
      if @classification.update(classification_params)
        format.html do
          redirect_to classification_url(@classification), notice: 'Classification was successfully updated.'
        end
